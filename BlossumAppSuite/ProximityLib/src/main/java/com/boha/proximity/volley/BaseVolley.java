package com.boha.proximity.volley;
...
import com.boha.proximity.library.WebCheck;
import com.boha.proximity.library.WebCheckResult;
...
public class BaseVolley {
    ...
    public static boolean checkNetworkOnDevice(Context context) {
        ...
        if (r.isNetworkUnavailable()) {
            Toast.makeText(ctx, "Network unavailable at this time", Toast.LENGTH_LONG).show();
            return false;
        }
